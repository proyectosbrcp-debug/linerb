...
| Credenciales V1 | Usuario operativo local y clave embebida en V1 | Permitía navegar a selección de línea. Cualquier otra combinación mostraba `Usuario o contraseña incorrectos`. | Las credenciales estaban embebidas en el cliente; no había backend ni sesión. | Reemplazado en Sprint 4.4 por Firebase Auth. | No se conservan valores de contraseña en el repositorio. |
